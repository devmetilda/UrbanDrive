  ...
  return car ? (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16 mb-24'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        {/* Right: Booking Form */}
        <form className='shadow-lg h-max sticky top-24 rounded-xl p-6 space-y-6 text-gray-500 bg-white'>
                
          <p className='flex items-center justify-between text-2xl text-gray-800 font-semibold'>
            {currencyy}{car.pricePerDay}
          ...
          <button 
            type="submit"
            className='w-full bg-[#B30812] hover:bg-[#8F0610] transition-all py-3 font-medium text-white rounded-xl cursor-pointer'
          >
            Book Now
          </button>
